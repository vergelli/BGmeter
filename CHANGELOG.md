...
- The recorder now samples every player's damage along with the team scores, and the report draws a DAMAGE RACE strip under the score chart: one line per team and your own line in gold. Matches recorded before this have no strip.
