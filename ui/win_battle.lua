...
local function build_battle(win)
    ...
    b.balTiltL = P.icon(b.bal)
    b.balTiltL:SetDimensions(18, 18)
    b.balTiltL:SetAnchor(LEFT, b.balScore, RIGHT, 4, 0)
    b.balTiltBar = P.rect(b.bal, { 1, 1, 1, 0.10 })
    b.balTiltBar:SetDimensions(56, 4)
    b.balTiltBar:SetAnchor(LEFT, b.balTiltL, RIGHT, 3, 0)
    b.balTiltR = P.icon(b.bal)
    b.balTiltR:SetDimensions(18, 18)
    b.balTiltR:SetAnchor(LEFT, b.balTiltBar, RIGHT, 3, 0)
    ...
    b.balTiltEnd = 6 + BAL_ICON + 5 + 30 + 4 + 18 + 3 + 56 + 3 + 18
    b.balCampX = 180
